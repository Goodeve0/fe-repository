Promise.myAll = function (promiseArr) {
  return new Promise((resolve, reject) => {
    if (promiseArr == null || typeof promiseArr[Symbol.iterator] !== 'function')
      throw new TypeError(`${promiseArr} is not an iterator`);
    const ans = [];
    let index = 0;
...
const p14 = Promise.myAll().then(console.log);
